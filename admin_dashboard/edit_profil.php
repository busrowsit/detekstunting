...
<body>
    ...
    <div class="input-box">
        ...
        <input type="email" name="email" value="<?= $user['email'] ?? '' ?>" placeholder="Email (Opsional)">
    </div>
    <div class="input-box">
    ...
    <input type="password" name="password" id="passwordInput" placeholder="Password Baru (Opsional)">
        ...
        <img src="cuteprofileadmin.png" alt="Pumpkin" class="hero-img" style="width: auto; height: auto;">
