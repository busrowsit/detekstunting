...
<body>
    ...
    <img src="logo-01.png">
        ...
        <nav class="nav-menu">
            ...
            <a href="login/index.php">Deteksi Stunting</a>
    ...
    <section id="main" class="hero">
        <div class="hero-content">
            <p class="top-text">#1 MASALAH GIZI DI INDONESIA</p>
            ...
            <div class="buttons">
                <a href="login/index.php" class="btn btn-primary">Deteksi Sekarang</a>
                <a href="#pengertian" class="btn btn-secondary">Pelajari Stunting</a>
            </div>
        </div>
        <img src="anak_Mesa de trabajo 1.png" alt="Pumpkin" class="hero-img">
    </section>
    ...
    <section id="pengertian" class="hero hidden">
        ...
        <img src="anak 2-01.png" alt="Pumpkin" style="max-width: 400px; animation: slideIn 1s ease-in-out;">
    </section>
